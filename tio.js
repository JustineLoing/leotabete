...
const esce = ('© L e o t a')
const ini_kangbaned = `0@s.whatsapp.net`
const ownernya = ownernomer + '@s.whatsapp.net'
global.prem = require("./lib/premium")
gambar = fs.readFileSync('./media/image/leota.jpg')
//TIME
...
break
            ...
            case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                tio.sendMessage(m.chat, { image: fs.readFileSync('./media/image/leota.jpg'), caption: `*${ucapanWaktu} Kak ${m.pushName}*\n\n *Jika ingin berdonasi silahkan hubungi owner terlebih dahulu*\n\n_Terima kasih_` }, { quoted: m })
            }
            break
            case 'sc': {
